...
public class MainPETCARActivity extends AppCompatActivity
    ...
    private void openMap() {
        ...
        MapPETCARFragment map =  MapPETCARFragment.newInstance();
        map.setRetainInstance(true);

        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().replace(R.id.container, map, "MAP_PETCAR")
