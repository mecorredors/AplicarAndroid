...
public class AdjuntoPetCar extends ModelBase {
    ...
    public String Path;
    public int IDTipoMaterialRecogido;
    public int Estado;
    ...
    public static final String IDMATERIAL_RECOGIDO = "IDTipoMaterialRecogido";
    ...
    public AdjuntoPetCar(Cursor c)
    {
        ...
        if(c.getColumnIndex(IDMATERIAL_RECOGIDO)>=0) this.IDTipoMaterialRecogido = c.getInt(c.getColumnIndex(IDMATERIAL_RECOGIDO));
